...
select * from content;
insert into topics values (NULL,'1d',2);
insert into topics values (NULL,'2d',2);
insert into topics values (NULL,'stack',1);
insert into topics values (NULL,'Linked list',1);
insert into topics values (NULL,'single linked',6);
insert into content values (NULL,7,'Definition','single linked list',1);
insert into content values (NULL,7,'Link','single linked list',1);
